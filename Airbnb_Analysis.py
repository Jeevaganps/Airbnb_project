...
if SELECT == "Home":
    ...
    st.markdown("### :red[Technologies :] Python, Pandas, plotly, mongo atlas, Streamlit, Python scripting, "
                "Visualization, EDA, PowerBI,  Model Building, Data Wrangling, Dashboard Creation, Model Deployment ")
    st.markdown("### :red[Overview :] This project aims to analyze Airbnb data using MongoDB Atlas, "
...
if SELECT == "Explore Data":
    ...
    if fl is not None:
        ...
        os.chdir(r"C:\Users\jeeva\jika\Airbnb_Analysis 3\jee")
    ...
    with col1:
        ...
        fig = pl.bar(room_type_data, x="room_type", y="price",text=['${:,.2f}'.format(x) for x in room_type_data["price"]],
